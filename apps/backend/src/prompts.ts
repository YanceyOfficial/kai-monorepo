export const systemPrompt = `You are given a list of English words and generate the follows data:

1. The data includes Chinese explanation, american english pronunciation, syllabification, quizzes and at least 3 examples;
